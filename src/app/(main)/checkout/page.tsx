  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <p className="mt-2 text-sm text-stone-600 sm:text-base">
        Choose your location, confirm your details, then pay with M-Pesa (Buy goods). You&apos;ll confirm your
        payment on the order page after sending money.
      </p>

      <section className="mt-6 space-y-4 rounded-2xl border border-stone-200 bg-white p-4 shadow-sm sm:p-6">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-stone-700">Order summary</h2>
